class BusMapApp {
  ...
  showRouteForVehicle(routeId, vehicleId, color) {
    ...
    if (matchingShapes.length > 0) {
      // Pokušaj da matchuješ na osnovu smera (A ili B)
      let selectedShape = matchingShapes[0]; // default
      
      // Proveri da li možemo da odredimo smer iz shape imena
      if (matchingShapes.length >= 2) {
        // Pogledaj koja je krajnja stanica za svaki shape
        // Za sada koristimo prvi, ali ćemo dodati logiku
        console.log('Imam više shapes, moram da odredim pravi smer');
        
        // TODO: ovde treba da uporedimo destination sa završnim tačkama shapes
        // Za sada ćemo koristiti jednostavnu heuristiku
      }
