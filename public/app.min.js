class BusMapApp {
  ...
  showRouteForVehicle(routeId, vehicleId, color) {
    ...
    // Search for shapes that contain this routeId
    for (let shapeKey in this.shapesData) {
      // Check if shape_id starts with the routeId
    ...
    // If we have a specific shapeId from vehicle, try to use it
    let selectedShape = null;
    if (shapeIdFromVehicle && this.shapesData[shapeIdFromVehicle]) {
      selectedShape = shapeIdFromVehicle;
    } else {
      // Otherwise use the first matching shape
